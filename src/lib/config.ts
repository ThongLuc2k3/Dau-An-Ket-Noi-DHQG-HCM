export const CV_CONFIG={model:'DAKN-grid-gradient',modelVersion:'1.0.0',dimension:384,inputSize:224,scanIntervalMs:900,topK:1,embeddingThreshold:0.85,marginThreshold:0,minGoodMatches:0,minInliers:0,minInlierRatio:0,maxFrameEdge:512} as const;
